                    ...
                    <div className="col col-xl-8 col-lg-10">
                        <div className="cta-content">
                            <div className="video-holder">
                                <button className="btn-wrap" onClick={() => setOpen(false)}><i className="fi flaticon-video-player" aria-hidden="true"></i><span className='text-white'>See more about our company</span></button>
                            </div>
